...
class _NetworkDashboardUIState extends State<NetworkDashboardUI> {
  ...
  Future<void> _initializeP2P() async {
    ...
    if (granted) {
      ...
      if (!widget.isHost) {
        _startDiscovery(); // clients discover
      } else {
        debugPrint("Hosting P2P group — waiting for devices to join.");
      }
    }
  }
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              widget.isHost
                  ? 'Hosting network — waiting for devices'
                  : _isDiscovering
                      ? 'Discovering devices...'
                      : 'Nearby Devices',
                ...
                child: Center(
                  child: Text(
                    _permissionsGranted
                        ...
                        : 'Permissions required to enable P2P',
        ...
        children: [
          if (!widget.isHost)
            FloatingActionButton(
              ...
              mini: true,
              child: Icon(_isDiscovering
                  ? Icons.stop
                  : Icons.refresh),
              tooltip: _isDiscovering
                  ? 'Stop scanning'
                  : 'Rescan devices',
            ),
